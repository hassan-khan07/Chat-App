...
// // socket.emit() = sending to one specific client (the one connected via that socket).
...
// diff between socket and io
// io → Global (server-wide) or all clients
// Used when you want to send/receive events involving all clients.
// socket = local, single client
// Used when you want to send/receive events involving just one client.

// diff between io and emit
// emit = sending message
// on = receiving message (listening for event)
